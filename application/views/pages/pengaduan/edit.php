                ...
                <div class="card-body custom-input">
                    <form class="row g-3" method="post" action="<?= base_url('Pengaduan/edit'); ?>/<?= $data->id_pengaduan ?>" enctype="multipart/form-data">
                        <div class="col-6"> 
                            ...
                            <input class="form-control" id="first-name" type="text" placeholder="First name" aria-label="First name" value="<?= $data->nama_pengadu ? $data->nama_pengadu : $data->nama; ?>" disabled>
                        </div>
                        <div class="col-4">
                            <label class="form-label" for="exampleFormControlInput1">Tanggal Pengaduan</label>
                            <input class="form-control" id="first-name" type="text" placeholder="First name" aria-label="First name" value="<?= $data->create_date ?>" disabled>
                        </div>
                        <div class="col-4"> 
                            ...
                            <select class="form-select" name="kategori" required="">
                                ...
                                <option  <?= ($k->id_jenispengaduan == $data->id_jenispengaduan)? 'selected' : ''; ?> value="<?= $k->id_jenispengaduan ?>"><?= $k->jenis_pengaduan ?> </option>
                                <?php endforeach ?>
                            </select>
                        </div>
                        <div class="col-4"> 
