                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" placeholder="Nama Lengkap" value="<?= $profile['nama']; ?>" name="nama" disabled>
                                </div>
                                </div>
                                <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Alamat</label>
                                    <input class="form-control" type="text" placeholder="Alamat Lengkap" value="<?= $profile['alamat']; ?>" name="alamat" disabled>
                                </div>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                <div class="mb-3">
                                    <label class="form-label">Email</label>
                                    <input class="form-control" type="email" placeholder="Email" value="<?= $profile['email']; ?>" name="email" disabled>
                                </div>
                                </div>
