        ...
        <div class="row gx-md-8 gx-xl-12 gy-8">
          ...
          <div class="col-lg-6">
            <div class="post-header mb-5">
              ...
              <p class="price fs-20 mb-2"><span class="amount"><?= $pengaduan->jenis_pengaduan; ?></span></p>
              <p class="price fs-20 mb-2"><span class="badge bg-<?= $pengaduan->status_color; ?>"><?= $pengaduan->status; ?></span></p>
              <div class="post-category text-line">

                <a href="javascript:;" rel="category"><i class="uil uil-file-alt fs-15"></i> Oleh : <?= $pengaduan->visibilitas == 1 ? $pengaduan->nama : 'Anonim'; ?> | <?= $pengaduan->create_date; ?></a>
              </div>
            </div>
            <!-- /.post-header -->
            <p class="mb-6"><?= $pengaduan->deskripsi_pengaduan; ?></p>
                  ...
                  <div class="card card-sm card-border-start border-primary" style="height: 8rem">
                    <div class="card-body">
                      ...
                      <div class="comment-header d-md-flex align-items-center">
                        <figure class="user-avatar"><img class="rounded-circle" alt="" src="<?= base_url();?>upload-profile/<?= $k['foto_profile'] ? $k['foto_profile'] : 'user.png'; ?>" /></figure>
                        <div>
